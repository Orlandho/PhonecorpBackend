 ...
 * Crea órdenes de venta: valida stock, calcula subtotales, aplica IGV (18%)
 * y agrega recargo de S/ 15.00 si la modalidad es "Envío a Domicilio".
 */
@RestController
...
public class OrdenVentaController {
    ...
    @Autowired
    public OrdenVentaController(IOrdenRepository ordenRepository,
    ...
    public OrdenVentaResponseDTO crearOrden(@RequestBody OrdenVentaRequestDTO request) {
        ...
        // Guardar la orden con monto temporal (se actualiza al final)
        ...
        // Procesar ítems: validar stock y calcular subtotales
        ...
        // Calcular montos: subtotal + IGV 18% + recargo envío si aplica
        ...
        return toResponseDTO(ordenGuardada, detalles, subtotalBase, igvMonto, recargoEnvio, montoTotal);
    }
    ...
    public OrdenVentaResponseDTO obtenerOrden(@PathVariable Integer idOrden) {
        ...
        BigDecimal subtotal = detalles.stream()
                .map(EntidadDetalleOrden::getSubtotal)
        ...
        return toResponseDTO(orden, detalles, subtotal, igv, recargo, orden.getMontoTotal());
    }

    private OrdenVentaResponseDTO toResponseDTO(EntidadOrdenVenta orden,
